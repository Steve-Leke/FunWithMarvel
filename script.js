...
//   }
//  let newElement = `
//   <h2>The name of the this movie is ${movieIronMan["title"]}<h2>
//   <p>It was released on ${movieIronMan["releaseDate"]}</p>
    ...
    <div class="flip-card">
      <div class="flip-card-inner">
          ...
          <div class="flip-card-back">
            <p id="introText">
            <h2>${movieListDetailed[i]["title"]}<h2>
            <p>It was released on ${movieListDetailed[i]["releaseDate"]}.</p>
            <p>Marvel describes it as "${movieListDetailed[i]["description"]}"</p>
            </p>
          </div>
      </div>
    </div>
